...
public class CommandManager {
    ...
    public synchronized void executeCommand(CommandMsg commandMsg, AnswerMsg ans){
        ...
        if (commandMsg.checkSystem()){
            if (commandMsg.getCommandName().trim().equals("get_collection")){
                ans.setObjAnswer(collectionManager.getMyCollection());
            }
            return;
        } else if (commandMsg.getCommandName().trim().equals("help")) {
